...
znamenatel_poned = open("poned_znam.txt").read()

znamenatel_vtor = open("vtor_znam.txt").read()

znamenatel_sred = open("sred_znam.txt").read()

znamenatel_chet = open("chet_znam.txt").read()

znamenatel_pyat = open("pyat.txt").read()
